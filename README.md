This is our first ALX Simple Shell Team Project. In this project, we learned how to create our own shell.

And in this project, We were tasked to create a simple shell that mimics the Bash shell. Our shell shall be called hsh
